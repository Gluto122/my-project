...
//membuat struct untuk menampung data ktp
struct KTP {
	string nik;
	string nama;
...
// membuat void untuk menginput data kedalam member struct
...
//membuat void untuk menampilkan ktp 
...
//memanggil void untuk ditampilkan
int main(){
	KTP ktp;
